...
export default function AdventureDetail() {
  ...
  useEffect(() => {
    ...
    if (currentArc) {
      ...
      // If episode and short params are provided, select that specific short
      ...
      // Otherwise, set the first short of the first episode as active
  ...
  const handleVideoEnded = () => {
    ...
    // Create a flat list of all shorts for easier navigation
    ...
    if (currentIndex !== -1 && currentIndex < allShorts.length - 1) {
      // Play the next short in the flat list
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-[#0C1021] to-[#181C28] text-white">
        ...
        <div className="flex-grow flex flex-col items-center justify-center">
            ...
            <Link to="/adventures" className="mt-4 text-[#FFA64D] hover:underline">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 sticky top-24 self-start">
                <div className="aspect-video bg-black rounded-lg overflow-hidden shadow-2xl shadow-black/30">
                  {activeShort && (
                    <ReactPlayer
                      key={activeShort.url} // Add key to force re-render on URL change
                      url={activeShort.url}
                      playing={true}
                      controls={true}
                      width="100%"
              ...
              {/* Right Column: Episode List - Scrollable */}
